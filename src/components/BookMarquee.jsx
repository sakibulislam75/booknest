   ...
   return (
      <div className="bg-gradient-to-r from-purple-600 via-pink-500 to-red-500 text-white py-2 my-2 ">
         <Marquee gradient={false} speed={50} pauseOnHover>
            <span className="mx-6 font-medium">📚 New Arrivals: "The Kite Runner"</span>
            <span className="mx-6 font-medium">📖 New Arrivals: "Introduction to Algorithms"</span>
            <span className="mx-6 font-medium">🌟 Special Discount on Memberships – Join Now!</span>
            <span className="mx-6 font-medium">📚 New Arrivals: "A Brief History of Time"</span>
